  ...
  const MenuItem = (
    <React.Fragment>
      <Link
        ...
        className=" pr-[25px] focus:outline-none transition duration-150 ease-in-out hover:bg-[#285B96] hover:text-white rounded font-medium   px-5 py-2 "
      >
        Home
      </Link>
      <Link
  ...
  return (
    <div>
      <div className=" h-full text-white">
        {/* Code block starts */}
        <nav className=" shadow xl:block hidden w-full z-40 bg-primary">
              ...
              <div className="flex">
                ...
                <Link to="/" className="hidden xl:flex items-center ">
                  <div className="relative md:mr-6 my-2">
                    <button className="focus:outline-none  border-gray-300 border transition duration-150 ease-in-out hover:bg-[#285B96] hover:text-white rounded font-medium  px-5 py-2 ">
                      Contact
                    </button>
                  </div>
                </Link>
        ...
        <nav className="">
          <div className="py-4 px-6 w-full flex xl:hidden justify-between items-center z-40 bg-primary b">
            <Link to="/" className="">
              <h2 className=" text-xl text-white font-bold leading-normal pl-3">
                JOB PORTAL
              </h2>
                    ...
                    <ul className="f-m-m ">
                      <li className="flex flex-col mt-[30px] gap-2 text-black  rounded-md ">
                        ...
                        <Link
                          to="/contacts"
                          onClick={() => setShow(!show)}
                          className=" pr-[25px] focus:outline-none -gray-300  transition duration-150 ease-in-out hover:bg-[#285B96] hover:text-white -500 rounded font-medium  px-5 py-2 text-[14px]"
                        >
                          Contacts
                        </Link>
                      </li>
